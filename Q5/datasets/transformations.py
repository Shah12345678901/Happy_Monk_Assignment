...
class CropPad:
    ...
    def __call__(self, sample):
        ...
        if should_crop:
            cropped_image[crop_y_start:crop_y_finish, crop_x_start:crop_x_finish, :] =                sample['image'][image_y_start:image_y_finish, image_x_start:image_x_finish, :]
            cropped_mask[crop_y_start:crop_y_finish, crop_x_start:crop_x_finish] =                sample['mask'][image_y_start:image_y_finish, image_x_start:image_x_finish]
